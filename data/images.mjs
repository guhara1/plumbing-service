...
export const galleryImages = [
  { file: "work-01.webp", alt: "누수탐지 현장 작업", label: "누수탐지" },
  { file: "work-02.webp", alt: "누수공사 배관 보수 작업", label: "누수공사" },
  { file: "work-03.webp", alt: "하수구막힘 관통 작업", label: "하수구막힘" },
  { file: "work-04.webp", alt: "배수구막힘 뚫음 작업", label: "배수구막힘" },
  { file: "work-05.webp", alt: "배관막힘 점검 작업", label: "배관막힘" },
  { file: "work-06.webp", alt: "배관설비 시공 현장", label: "배관설비" },
  { file: "work-07.webp", alt: "주방 수전교체 작업", label: "수전교체" },
  { file: "work-08.webp", alt: "싱크대수전교체 작업", label: "싱크대수전교체" },
  { file: "work-09.webp", alt: "화장실수전교체 작업", label: "화장실수전교체" },
  { file: "work-10.webp", alt: "변기막힘 관통 작업", label: "변기막힘" },
  { file: "work-11.webp", alt: "화장실변기교체 작업", label: "변기교체" },
  { file: "work-12.webp", alt: "변기부속품수리 작업", label: "변기부속품수리" },
  { file: "work-13.webp", alt: "싱크대하수구막힘 작업", label: "싱크대하수구막힘" },
  { file: "work-14.webp", alt: "세면대막힘 작업", label: "세면대막힘" },
  { file: "work-15.webp", alt: "세면대교체 작업", label: "세면대교체" },
  { file: "work-16.webp", alt: "배수구뚫음 스프링 작업", label: "배수구뚫음" },
  { file: "work-17.webp", alt: "욕실배관누수 보수 작업", label: "욕실배관누수" },
  { file: "work-18.webp", alt: "수도누수 탐지 작업", label: "수도누수" },
  { file: "work-19.webp", alt: "주방배수구막힘 고압세척", label: "주방배수구막힘" },
  { file: "work-20.webp", alt: "배관내시경 점검 작업", label: "배관내시경" },
  { file: "work-21.webp", alt: "고압세척 배관 청소 작업", label: "고압세척" },
];
