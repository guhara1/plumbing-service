...
// 페이지별로 다른 키워드 조합을 내부링크 클라우드로 출력(도어웨이 방지: 시드 셔플).
// place 지정 시 "지역명 + 키워드" 롱테일 앵커가 되어 지역 SEO 에 유리하다.
export function keywordCloud(base, place, n = 8) {
  const pre = place ? `${place} ` : "";
  return `<div class="link-cloud">${vsubset(base, "kwcloud", keywordLinks, n)
